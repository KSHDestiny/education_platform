                ...
                <div class="card-body">
                    <form action="{{ route('category#delete',[$category->category_id]) }}" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <b class="text-white">The Category <span class="text-danger h6 text-uppercase">"{{ $category->title }}"</span> will be permanently deleted from Education Platform? <br><span class="text-warning">It may cause all the courses in this tilte will be automatically deleted. Are you still sure that you want to continue?</span></b>
                        </div>
                        <div class="d-flex justify-content-between mt-3">
                            <a href="{{ route('category#page') }}" class="btn btn-dark">Back</a>
